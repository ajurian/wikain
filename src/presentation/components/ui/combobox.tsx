...
function ComboboxChipsInput({
  className,
  // Destructured to keep it out of the spread — the input renders no children.
  children: _children,
  ...props
}: ComboboxPrimitive.Input.Props) {
  return (
